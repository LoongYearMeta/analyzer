...
(function() {
    ...
    const regionPlugin = {
        ...
        afterDatasetsDraw(chart) {
            ...
            const labelTop = a.top + 14 + (cornerNotes.length ? cornerNotes.length * 16 + 6 : 0);
            // 区带标签（各区带中心、自动避开角注下移）
            ctx.textAlign = 'center';
            REGIONS.forEach(r => {
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                ...
                y: { beginAtZero: true, title: { display: true, text: ${JSON.stringify(yLabel)} } }
            }
        },
